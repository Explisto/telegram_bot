...
bot = Bot(token='5793608089:AAEc_LxmkCcbFefkK2xwJVK9cGQje6lgcg0')
...
async def echo_send(message : types.Message): # Объявление асинхронной функции для ответа на сообщение
    if message.text == 'Привет':
        ...
        await message.answer('Неизвестная команда. Пожалуйста, действуйте в соответствии с инструкцией. Она доступна по кнопке "Помощь".') # Отправка сообщения пользователю
